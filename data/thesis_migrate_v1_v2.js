...
for (let i = 0; i < data_v2.length; ++i) {
    ...
    if (matrices_timings[name] === undefined) {
        matrices_timings[name] = {};
        console.log("Unknown matrix in v2 data");
    }
...
fs.writeFileSync('/home/lksri/repos/trigsolve-data-munch/thesis_postprocesssed_results_v2.json', JSON.stringify(filtered));