...
const data_v1 = JSON.parse(fs.readFileSync('/home/lksri/repos/trigsolve-data-munch/thesis_postprocesssed_results_v7.json', { encoding: 'utf8', flag: 'r' }));
const data_v2 = JSON.parse(fs.readFileSync('/home/lksri/repos/trigsolve-data-munch/thesis_full_results_v8_v100.json', { encoding: 'utf8', flag: 'r' }));
...
for (let i = 0; i < data_v2.length; ++i) {
    ...
    if (matrices_timings[name] === undefined) {
        ...
        console.log("Unknown matrix in v8 data");
    }
...
fs.writeFileSync('/home/lksri/repos/trigsolve-data-munch/thesis_postprocesssed_results_v8.json', JSON.stringify(filtered));