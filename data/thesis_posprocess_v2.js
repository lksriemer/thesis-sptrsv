...
const data = JSON.parse(fs.readFileSync('/home/lksri/repos/trigsolve-data-munch/thesis_full_results_stencils_v1_v100.json', { encoding: 'utf8', flag: 'r' }));
...
fs.writeFileSync('/home/lksri/repos/trigsolve-data-munch/thesis_postprocesssed_results_stencils_v1.json', JSON.stringify(filtered));